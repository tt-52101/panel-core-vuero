                  ...
                  <Multiselect
                    ...
                    :options="[
                      ...
                      },
                      {
                        value: 'melany',
                        name: 'melany Wallace',
                        image: '/vdemo/avatars/25.jpg',
                      },
                      {
                        value: 'tara',
                        name: 'Tara Svenson',
                        image: '/vdemo/avatars/13.jpg',
                      },
                      {
                        value: 'mary',
                        name: 'Mary Lebowski',
                        image: '/vdemo/avatars/5.jpg',
                      },
                      {
                        value: 'irina',
                        name: 'Irina Vierbovsky',
                        image: '/vdemo/avatars/23.jpg',
                      },
                      {
                        value: 'jonathan',
                        name: 'Jonathan Krugger',
                        image: '/vdemo/avatars/32.jpg',
                      },
                    ]"
                    :max-height="145"
                  >
