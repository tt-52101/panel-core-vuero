...
export const datatableV1 = {
  ...
  data: {
    ...
    data: [
      ...
      [1, '/vuero/avatars/7.jpg', 'Alice Carasca', 'Software Engineer', 'offline', true],
      [2, '/vuero/avatars/13.jpg', 'Tara Svenson', 'UI/UX Designer', 'offline', true],
      [3, '/vuero/avatars/5.jpg', 'Mary Lebowski', 'Project Manager', 'available', true],
      [
        4,
      ...
      [5, '/vuero/avatars/27.jpg', 'Carmen Escudero', 'HR Manager', 'offline', true],
      [6, '/vuero/avatars/22.jpg', 'Dwayne Hicks', 'Product Manager', 'offline', true],
      [
        7,
      ...
      [
        8,
        '/vuero/avatars/23.jpg',
        'Irina Vierbovsky',
        'Project Manager',
        'available',
        true,
      ],
      [9, '/vuero/avatars/28.jpg', 'Edouard Falant', 'Web Developer', 'busy', true],
      [
        10,
        '/images/avatars/placeholder-f.jpg',
        'Shana Williams',
      ...
      [12, '/vuero/avatars/39.jpg', 'Alejandro Badajoz', 'Web Developer', 'busy', true],
      [
        13,
        '/vuero/avatars/21.jpg',
        'Elizabeth Fisher',
        'Mobile Developer',
        'available',
        true,
      ],
      [14, '/vuero/avatars/37.jpg', 'Helmut Fritz', 'Product Manager', 'available', true],
      [15, '/vuero/avatars/31.jpg', 'Yasseen Amzi', 'Business Analyst', 'offline', true],
    ],
  },
}
