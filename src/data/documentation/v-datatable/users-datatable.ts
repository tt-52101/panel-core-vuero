...
export const optionsUsers = {
  ...
  data: {
    ...
    data: [
      ...
      [1, '/vdemo/avatars/7.jpg', 'Alice Carasca', 'Software Engineer', 'offline', true],
      [2, '/vdemo/avatars/13.jpg', 'Tara Svenson', 'UI/UX Designer', 'offline', true],
      [3, '/vdemo/avatars/5.jpg', 'Mary Lebowski', 'Project Manager', 'available', true],
      [
        4,
      ...
      [5, '/vdemo/avatars/27.jpg', 'Carmen Escudero', 'HR Manager', 'offline', true],
      [6, '/vdemo/avatars/22.jpg', 'Dwayne Hicks', 'Product Manager', 'offline', true],
      [
        7,
      ...
      [
        8,
        '/vdemo/avatars/23.jpg',
        'Irina Vierbovsky',
        'Project Manager',
        'available',
        true,
      ],
      [9, '/vdemo/avatars/28.jpg', 'Edouard Falant', 'Web Developer', 'busy', true],
      [
        10,
        '/images/avatars/placeholder-f.jpg',
        'Shana Williams',
      ...
      [12, '/vdemo/avatars/39.jpg', 'Alejandro Badajoz', 'Web Developer', 'busy', true],
      [
        13,
        '/vdemo/avatars/21.jpg',
        'Elizabeth Fisher',
        'Mobile Developer',
        'available',
        true,
      ],
      [14, '/vdemo/avatars/37.jpg', 'Helmut Fritz', 'Product Manager', 'available', true],
      [15, '/vdemo/avatars/31.jpg', 'Yasseen Amzi', 'Business Analyst', 'offline', true],
    ],
  },
}
